...
<body>
    ...
    <form action="find_proc.jsp?item=id" method="post" class="form1" name="findId">
      ...
      <input class="pass" name="login_email" type="text" align="center" placeholder="Email">
      
      <button class="submit_findid_findpw" onclick="document.findId.submit()">아이디 검색</button>
