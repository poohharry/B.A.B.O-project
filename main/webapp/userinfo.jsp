...
<<<<<<< HEAD
            ...
            <div class="selectdiv">
            	<section class="selectsection">
	            	...
	            	<input type="radio" name="black" value="1" checked/>1일 활동정지<br>
	            	<input type="radio" name="black" value="3" />3일 활동정지<br>
	            	<input type="radio" name="black" value="7" />7일 활동정지<br>
	            	<input type="radio" name="black" value="15" />15일 활동정지<br>
	            	<input type="radio" name="black" value="30" />30일 활동정지<br>
	            	<input type="radio" name="black" value="0" />영구 활동정지<br><br>
